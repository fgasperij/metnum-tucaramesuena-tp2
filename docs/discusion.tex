...
Los resultados obtenidos son . Se esperaba que a una resolución mayor la cantidad de información de la imágen fuera mayor, pero al parecer es la misma, ya que no importan las condiciones la tasa de eficiencia es prácticamente la misma par ambos tamaños de imágenes.
